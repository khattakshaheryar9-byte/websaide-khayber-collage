...
export const FACULTY_DATA: FacultyMember[] = [
  {
    id: 'fac-1',
    name: 'Dr. Asif Khattak',
    designation: 'Director of Khyber College',
    department: 'Executive Leadership & Administration',
    qualification: 'Ph.D. in Education & Leadership, Post-Doc Research',
    experience: '20+ Years in Educational Administration & Institutional Development',
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=600',
    bio: 'Dr. Asif Khattak is the visionary founder and Director of Khyber College of Global Sciences & Professional Education. Under his strategic guidance, the college has established itself as a premier technical and academic institution in Dargai, Charsadda, fostering world-class skill development and ethical character building.',
    email: 'khattakshaheryar9@gmail.com',
    socials: { linkedin: 'https://linkedin.com' }
  },
  {
    id: 'fac-2',
    name: 'Engr. Shaheryar Khattak',
  ...
  {
    id: 'fac-3',
    name: 'Engr. Abuzar Khan',
    designation: 'Senior Lecturer & Web Tech Lead (1st Instructor)',
    department: 'Software Engineering & Web Development',
    qualification: 'MS Computer Science, AWS Certified Solutions Architect',
    experience: '8+ Years in Full-Stack Web Development & Mentorship',
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=600',
    bio: 'Engr. Abuzar Khan brings practical software industry standards into the classroom. As the lead lecturer for web technologies and programming, he has mentored hundreds of students who are now thriving on platforms like Upwork and Fiverr and working in top software houses.',
    email: 'abuzar.khan@khybercollege.edu.pk',
    socials: { linkedin: 'https://linkedin.com' }
  },
  {
    id: 'fac-4',
    name: 'Dr. Iqra Asif',
    designation: 'Senior Lecturer & Head of Humanities (2nd Instructor)',
    department: 'Humanities, Linguistics & Professional Communication',
    qualification: 'Ph.D. in Applied Linguistics, CELTA (UK), IELTS 8.5 Band',
    experience: '9+ Years as English Proficiency & Corporate Trainer',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=600',
    bio: 'Dr. Iqra Asif leads the English language and professional communication department. Her interactive psycholinguistic teaching methods eliminate public speaking hesitation and help students achieve top scores in international IELTS and English proficiency exams.',
    email: 'iqra.asif@khybercollege.edu.pk'
  },
  {
    id: 'fac-5',
...
export const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    rating: 5,
    review: 'Before joining Khyber College, I had no coding experience. Within 6 months of intense training with Engr. Abuzar Khan, I built my first SaaS app and now I earn consistently as a Top Rated seller on Upwork! The supportive lab environment is unmatched in Charsadda.',
  ...
  },
  {
    ...
    graduationYear: 'Class of 2024',
    rating: 5,
    review: 'I scored an overall 7.5 Band in IELTS Academic after taking the 3-month preparatory course with Dr. Iqra Asif. The regular mock speaking tests and audio labs cured my hesitation completely. Highly recommended!',
